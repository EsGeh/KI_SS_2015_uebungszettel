...
if __name__ == '__main__':
    print truthtable(['p','q','r'], [('\{ p|q|r, r=> (p|q), (q \& r)=>p, \sim p | q | r\}', lambda p,q,r: (p or q or r) and ( not r | (p or q)) and (not (q and r) | p) and (not p or q or r)),
                                 ('(q => p)| \sim(1 => (p | r))',lambda p,q,r: (not q or p) or not (not q or (p or r))),
                                 ])
